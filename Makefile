# This Makefile is for the Data::Random::String extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Data/Random/String.pm]
#     AUTHOR => q[root <root@marmaridis.org>]
#     NAME => q[Data::Random::String]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Data/Random/String.pm]
...
FULLEXT = Data/Random/String
BASEEXT = String
PARENT_NAME = Data::Random
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Data/Random/String.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Data/Random
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Data/Random
...
TO_INST_PM = lib/Data/Random/String.pm

PM_TO_BLIB = lib/Data/Random/String.pm \
...
DISTNAME = Data-Random-String
DISTVNAME = Data-Random-String-0.0.1
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Data/Random/String.pm $(INST_MAN3DIR)/Data::Random::String.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Data-Random-String' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.0.1' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Data/Random/String.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for creating random strings</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>root &lt;root@marmaridis.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Data/Random/String.pm blib/lib/Data/Random/String.pm 
